...
function socialMainCarousel() {
    ...
    this.cargeMatrixSocial = function (x) {
        ...
        if (this.dataMatrix[x][4] == "N/A") {
            ...
            document.getElementById("s_main_link_github").href = this.dataMatrix[x][4]
        ...
        if (this.dataMatrix[x][5] == "N/A") {
            ...
            document.getElementById("s_main_link_linkedin").href = this.dataMatrix[x][5]
        ...
        if (this.dataMatrix[x][6] == "N/A") {
            ...
            document.getElementById("s_main_link_deploy").href = this.dataMatrix[x][6]
...
function time2() {
    ...
    if (segNow < 58000) {
        ...
        document.getElementById("s_main_bar").style.width = this.widthValue
        document.getElementById("s_carousel_main").style.transition = "opacity 0.5s"
    }
    else {
        this.widthValue = 0 + "%"
        socialRecomendation.cargeMatrixSocial(numberSocial)
