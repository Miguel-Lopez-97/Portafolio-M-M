...
function mainCarousel() {
  ...
  this.changeRuteImage = "media/images/Diapositiva" + numberChangeIntroduce + ".PNG";
...
function academicMainCarousel(){
    this.dataMatrix = [
        [["WandaVision"],["CSS-Landing page Nov-21"],["https://www.disneyplus.com/series/wandavision/4SrN28ZjDLwH?irclickid=xoOQ8v1X-xyIT3K34FT2OQBMUkGwGI2P-0qRTU0&irgwc=1&cid=DSS-Affiliate-Impact-Content-JustWatch%20GmbH-705874"],["media/images/Prof_Carousel/prof_img_main_1.png"],["Wanda Maximoff and Vision are living an idyllic suburban life in the town of Westview, New Jersey, trying to conceal their true natures."],["https://www.justwatch.com/co/serie/bruja-escarlata-y-vision"],["media/ico/Ico_Engineering.png"]],
        [["Portfolio M&M"],["Business page Nov-21"],["https://miguelmorenoportafolio.netlify.app/"],["media/images/Prof_Carousel/prof_img_main_2.png"],["This is a main page about my work as Web Development"],["https://github.com/Miguel-Lopez-97/Portafolio-M-M"],["media/ico/Ico_Engineering.png"]],
        [["Jurassic Park"],["Landing page Nov-21"],["https://sleepy-archimedes-03d4ce.netlify.app/"],["media/images/Prof_Carousel/prof_img_main_0.png"],["This is a tribute page about my favorite saga in all the time"],["https://github.com/Miguel-Lopez-97/Landing-page-Jurassic-World-Novedades"],["media/ico/Ico_Web-development.png"]],
        [["Hangman Game"],["Game page with JS Nov-21"],["https://juegoahorcadodiplo99.netlify.app"],["media/images/Prof_Carousel/prof_img_main_3.png"],["Hangman games for home This project is a hangman game developed for the home games company"],["https://github.com/Miguel-Lopez-97/Juego-del-Ahorcado"],["media/ico/Ico_Teaching.png"]]
    ]
    this.x=0
    this.y=1
    ...
    this.cargeMatrixAcademical = function(x,y){
        ...
        document.getElementById("a_main_link_deploy_0").href=this.dataMatrix[x][2]
        document.getElementById("a_main_link_github_0").href=this.dataMatrix[x][5]
        ...
        document.getElementById("a_main_link_deploy_1").href=this.dataMatrix[y][2]
        document.getElementById("a_main_link_github_1").href=this.dataMatrix[y][5]
    ...
    this.a_img_principal_0 = function(){
        ...
        document.getElementById("a_principal_imgclass_0").src=this.dataMatrix[this.x][3]
        document.getElementById("a_principal_name_0").innerHTML=this.dataMatrix[this.x][0]
        document.getElementById("a_principal_link_0").href=this.dataMatrix[this.x][2]
    }
    ...
    this.a_img_principal_1 = function(){
        ...
        document.getElementById("a_principal_imgclass_1").src=this.dataMatrix[this.y][3]
        document.getElementById("a_principal_name_1").innerHTML=this.dataMatrix[this.y][0]
        document.getElementById("a_principal_link_1").href=this.dataMatrix[this.y][2]
    }
...
function socialMainCarousel(){
    this.dataMatrix = [
        [["media/images/Social_Carousel/social_img_main_1.png"],["Cristian Montoya"],["Web FullStack Developer"],["Miguel es un excelente desarrollador con gran capacidad de aplicación de soluciones reales, sin duda trabajaría con el cada que lo requiera."],["https://github.com/CristianMontoya98"],["N/A"],["N/A"]],
        [["media/images/Social_Carousel/social_img_main_2.png"],["Lizzete Sevillano"],["Web FullStack Developer - Psychologist "],["Miguel es un líder nato, expresa sus opiniones con asertividad y entusiasmo, aporta ideas a nivel logístico y creativo manteniendo un equilibrio entre creatividad, funcionalidad y objetivos de la tarea que tenga a cargo. Si necesitas una persona para liderar tu equipo y que realice un trabajo ordenado y pulcro, !No dudes en contactarlo!"],["https://github.com/LizzieSevC"],["https://www.linkedin.com/in/edna-lizette-sevillano-castillo-46570218b/"],["N/A"]],
        [["media/images/Social_Carousel/social_img_main_0.png"],["Miguel Moreno"],["Web FullStack Developer - Petroleum Engineer"],["Mike is is an excellent person, he is dedicated, collaborative, empathetic. He is committed to his work, he has great ideas and knows how to plan them well to be able to execute them, he has a well-developed sense of design and logic."],["https://github.com/Miguel-Lopez-97"],["https://www.linkedin.com/in/miguel-angel-moreno-l%C3%B3pez/"],["https://miguelmorenoportafolio.netlify.app/"]]
    ]
    ...
    this.cargeMatrixSocial = function(x){
        ...
        if(this.dataMatrix[x][4]=="N/A"){
            ...
            else{document.getElementById("s_main_link_github").href=this.dataMatrix[x][4]
            Open("s_main_link_github")}
        if(this.dataMatrix[x][5]=="N/A"){
            Close("s_main_link_linkedin")
            }
            else{document.getElementById("s_main_link_linkedin").href=this.dataMatrix[x][5]
            Open("s_main_link_linkedin")}
        if(this.dataMatrix[x][6]=="N/A"){
            Close("s_main_link_deploy")}    
            else{document.getElementById("s_main_link_deploy").href=this.dataMatrix[x][6]
